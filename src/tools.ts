...
export const executionTools: ToolDefinition[] = [
  {
    ...
    description: "Use any configured AI provider to translate text.",
    kind: "execution",
    section: "text",
    mode: "translate",
  ...
  },
  {
    ...
    description: "Rewrite text with the active prompt template and provider.",
    kind: "execution",
    section: "text",
    mode: "polishing",
  ...
  },
  {
    ...
    description: "Summarize pasted, selected, or OCR text with the active provider.",
    kind: "execution",
    section: "text",
    mode: "summarize",
...
export const configurationTools: ToolDefinition[] = [
  {
    ...
    description: "Configure the global API-compatible runtime.",
    kind: "configuration",
